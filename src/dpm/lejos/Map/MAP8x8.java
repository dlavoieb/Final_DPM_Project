...
public class MAP8x8 {
    ...
    public static Node[][] createMap1(){
        ...
        r5c0.addNeighbours(new Node[] {r4c0, r5c1});
        r5c1.addNeighbours(new Node[] {r5c0, r4c1, r5c2});
        ...
        r6c2.addNeighbours(new Node[] {r5c2, r7c2, r6c3});
        ...
        r7c2.addNeighbours(new Node[] {r6c2, r7c3});
